...
\begin{homeworkProblem}
    Find the Transfer function $\frac{X_3(s)}{F(s)}$ for each of the following:
...
\begin{align}
    ...
    \implies \frac{X_3(s)}{F(s)} = \frac{F(s)(13 s + 20)}{16 s^4 + 100 s^3 + 172 s^2 + 60 s}
\end{align}
...
\begin{align}
    ...
    \implies \frac{X_3(s)}{F(s)} = \frac{F(s)(128s^3 + 64 s^2 + 316 s + 15)}{384 s^5 + 1064 s^4 + 3476 s^3 + 165 s^2} 
\end{align}
